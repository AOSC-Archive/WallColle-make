...
// Project:     WallColle-make
// Repo:        https://github.com/neruthes/WallColle-make
// File:        make.js
...
fs.readFile(PACKPATH, function (err, stdin, stderr) {
    if (err) {
        console.error(`Error: Cannot make "${PACKNAME}".`);
        process.exit(1);
    };
